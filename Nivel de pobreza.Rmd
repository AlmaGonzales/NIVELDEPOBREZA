...
pobreza[,c(4:23)]=NULL
pobreza[,c(5,8,9,12,14,16:20)]=NULL
...
names(pobreza) = c("Provincia", "%Desnutricioncronica2018","%Anemia2018","IDH2019", "IDE2019","%Pobrezatotal2018","%Pobrezaextrema2018")

```

```{r}
str(pobreza)
pobreza$IDE2019 = as.numeric(pobreza$IDE2019) 
```
```{r}
